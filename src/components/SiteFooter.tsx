...
const footerCss = `
  .ez-footer { background:#640000; color:#fff; padding:0; font-family:"Noto Sans Arabic", Tajawal, system-ui, sans-serif; font-size:13.5px; line-height:1.75; }
  .ez-footer h3 { font-family:"Alexandria","Noto Sans Arabic",Tajawal,sans-serif; }
