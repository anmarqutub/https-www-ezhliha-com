...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "اكتشف مقدمي خدمات المناسبات في السعودية وتواصل معهم بسهولة عبر إزهليها." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "إزهليها — دليلك للمناسبات" },
      { name: "twitter:description", content: "اكتشف مقدمي خدمات المناسبات في السعودية وتواصل معهم بسهولة عبر إزهليها." },
    ],
    links: [
