...
function AdminServicesImportPage() {
  ...
  return (
    <div dir="rtl" style={{ maxWidth: 980, margin: "0 auto", padding: "28px 16px 60px" }}>
      <Link to="/admin" style={{ color: "#640000", fontSize: 13.5 }}>→ رجوع للوحة التحكم</Link>
      <h1 style={{ fontSize: 22, margin: "12px 0 6px", color: "#640000" }}>رفع ملف الخدمات</h1>
      ...
      <label
        style={{
          ...
          background: "#fdfaf6", cursor: "pointer", fontSize: 14, color: "#640000",
        }}
      >
        ...
        <>
          ...
          <button
            ...
            style={{
              ...
              background: stats.ok === 0 ? "#c9b8a8" : "#640000", color: "#fff", fontSize: 14,
