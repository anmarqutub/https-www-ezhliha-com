...
// ============ SITE TEXTS ============
type SiteTextRow = { key: string; value: string; label: string | null; updated_at: string; group?: string };

// نصوص إضافية (كانت مكتوبة داخل الصفحات) صارت كلها تتحكم منها من هنا
const SITE_TEXT_EXTRA: SiteTextRow[] = [
  // ——— الهيدر والقوائم ———
  { key: "nav.home", group: "الهيدر والقوائم", label: "القائمة — الرئيسية", value: "الرئيسية", updated_at: "" },
  { key: "nav.menu", group: "الهيدر والقوائم", label: "القائمة — زر القائمة", value: "القائمة", updated_at: "" },
  { key: "nav.providers", group: "الهيدر والقوائم", label: "القائمة — الدليل", value: "الدليل", updated_at: "" },
  { key: "nav.categories", group: "الهيدر والقوائم", label: "القائمة — الفئات", value: "الفئات", updated_at: "" },
  { key: "nav.cities", group: "الهيدر والقوائم", label: "القائمة — المدن", value: "المدن والمناطق", updated_at: "" },
  { key: "nav.faq", group: "الهيدر والقوائم", label: "القائمة — الأسئلة", value: "الأسئلة الشائعة", updated_at: "" },
  { key: "nav.contact", group: "الهيدر والقوائم", label: "القائمة — تواصل معنا", value: "تواصل معنا", updated_at: "" },
  { key: "nav.allCats", group: "الهيدر والقوائم", label: "القائمة — جميع الفئات", value: "جميع الفئات", updated_at: "" },
  { key: "nav.favorites", group: "الهيدر والقوائم", label: "القائمة — المفضلة", value: "المفضلة", updated_at: "" },
  { key: "mega.allIn", group: "الهيدر والقوائم", label: "القائمة الكبيرة — كل الخدمات", value: "كل الخدمات", updated_at: "" },
  { key: "hl.topbar", group: "الهيدر والقوائم", label: "الشريط العلوي", value: "أزهليها، دليلكِ لكل متطلبات مناسبتكِ", updated_at: "" },

  // ——— الصفحة الرئيسية (الواجهة) ———
  { key: "hl.hero.eyebrow", group: "الصفحة الرئيسية", label: "الواجهة — السطر الصغير", value: "دليل أزهليها", updated_at: "" },
  { key: "hl.hero.title", group: "الصفحة الرئيسية", label: "الواجهة — العنوان", value: "كل اللي تحتاجينه لمناسبتك في مكان واحد.", updated_at: "" },
  { key: "hl.hero.desc", group: "الصفحة الرئيسية", label: "الواجهة — الوصف", value: "تصفحي مزودي الخدمات، قارني بين الخيارات، واحفظي اللي يناسبك.", updated_at: "" },
  { key: "hl.hero.cta", group: "الصفحة الرئيسية", label: "الواجهة — الزر الأول", value: "تصفحي الدليل", updated_at: "" },
  { key: "hl.hero.cta2", group: "الصفحة الرئيسية", label: "الواجهة — الزر الثاني", value: "احفظي خياراتك", updated_at: "" },
  { key: "hl.how.title", group: "الصفحة الرئيسية", label: "الخطوات — العنوان", value: "اختاري بسهولة", updated_at: "" },
  { key: "hl.step.1", group: "الصفحة الرئيسية", label: "الخطوة ١ — العنوان", value: "حددي الخدمة", updated_at: "" },
  { key: "hl.step.1.d", group: "الصفحة الرئيسية", label: "الخطوة ١ — الوصف", value: "اختاري الفئة والمدينة وتطلع لك الخيارات الموجودة.", updated_at: "" },
  { key: "hl.step.2", group: "الصفحة الرئيسية", label: "الخطوة ٢ — العنوان", value: "قارني الخيارات", updated_at: "" },
  { key: "hl.step.2.d", group: "الصفحة الرئيسية", label: "الخطوة ٢ — الوصف", value: "تصفحي الأعمال والأسعار والتفاصيل قبل ما تختارين.", updated_at: "" },
  { key: "hl.step.3", group: "الصفحة الرئيسية", label: "الخطوة ٣ — العنوان", value: "تواصلي مباشرة", updated_at: "" },
  { key: "hl.step.3.d", group: "الصفحة الرئيسية", label: "الخطوة ٣ — الوصف", value: "أرسلي طلبك لمقدم الخدمة واتفقي معه على التفاصيل.", updated_at: "" },
  { key: "hl.cats.title", group: "الصفحة الرئيسية", label: "بطاقات الفئات — العنوان", value: "وش تحتاجين لمناسبتك؟", updated_at: "" },
  { key: "hl.cats.desc", group: "الصفحة الرئيسية", label: "بطاقات الفئات — الوصف", value: "اختاري الفئة وتطلع لك مزودي الخدمات الموجودين في مدينتك.", updated_at: "" },
  { key: "hl.journey.title", group: "الصفحة الرئيسية", label: "رحلة التجهيز — العنوان", value: "نكمل معك التفاصيل", updated_at: "" },
  { key: "hl.journey.desc", group: "الصفحة الرئيسية", label: "رحلة التجهيز — الوصف", value: "خطوات بسيطة تقربك من الخيار المناسب.", updated_at: "" },
  { key: "hl.journey.1.title", group: "الصفحة الرئيسية", label: "رحلة ١ — العنوان", value: "ابدئي بالقاعة", updated_at: "" },
  { key: "hl.journey.1.desc", group: "الصفحة الرئيسية", label: "رحلة ١ — الوصف", value: "قاعات وأماكن تناسب عدد ضيوفك وميزانيتك.", updated_at: "" },
  { key: "hl.journey.1.cta", group: "الصفحة الرئيسية", label: "رحلة ١ — الزر", value: "تصفحي القاعات", updated_at: "" },
  { key: "hl.journey.2.title", group: "الصفحة الرئيسية", label: "رحلة ٢ — العنوان", value: "اختاري المصورة", updated_at: "" },
  { key: "hl.journey.2.desc", group: "الصفحة الرئيسية", label: "رحلة ٢ — الوصف", value: "مصورات يوثقون ذكرياتك بأسلوب يعجبك.", updated_at: "" },
  { key: "hl.journey.2.cta", group: "الصفحة الرئيسية", label: "رحلة ٢ — الزر", value: "تصفحي المصورات", updated_at: "" },
  { key: "hl.journey.3.title", group: "الصفحة الرئيسية", label: "رحلة ٣ — العنوان", value: "رتبي تفاصيل مناسبتك", updated_at: "" },
  { key: "hl.journey.3.desc", group: "الصفحة الرئيسية", label: "رحلة ٣ — الوصف", value: "من الورد للديكور، اختاري التفاصيل اللي تكمل مناسبتك.", updated_at: "" },
  { key: "hl.journey.3.cta", group: "الصفحة الرئيسية", label: "رحلة ٣ — الزر", value: "تصفحي الخدمات", updated_at: "" },
  { key: "hl.journey.cta", group: "الصفحة الرئيسية", label: "رحلة التجهيز — زر أسفل القسم", value: "تصفحي الدليل", updated_at: "" },
  { key: "hl.picks.title", group: "الصفحة الرئيسية", label: "خيارات مختارة — العنوان", value: "خيارات تناسبك", updated_at: "" },
  { key: "hl.picks.desc", group: "الصفحة الرئيسية", label: "خيارات مختارة — الوصف", value: "تصفحي مزودي الخدمات واختاري الأنسب لك.", updated_at: "" },
  { key: "hl.picks.cta", group: "الصفحة الرئيسية", label: "خيارات مختارة — الزر", value: "تصفحي الدليل", updated_at: "" },
  { key: "hl.tc.pre", group: "الصفحة الرئيسية", label: "مربع العدد — السطر العلوي", value: "دليل أزهليها", updated_at: "" },
  { key: "hl.tc.label", group: "الصفحة الرئيسية", label: "مربع العدد — الوصف", value: "مزوّد خدمة", updated_at: "" },
  { key: "hl.tc.cta", group: "الصفحة الرئيسية", label: "مربع العدد — الزر", value: "تصفحي المزوّدين", updated_at: "" },

  // ——— إعلان الصفحة الرئيسية ———
  { key: "hl.ad.eyebrow", group: "إعلان الصفحة الرئيسية", label: "الإعلان — السطر الصغير", value: "تحت الضوء هذا الشهر", updated_at: "" },
  { key: "hl.ad.name", group: "إعلان الصفحة الرئيسية", label: "الإعلان — الاسم الافتراضي", value: "مزوّد خدمة مميز", updated_at: "" },
  { key: "hl.ad.meta", group: "إعلان الصفحة الرئيسية", label: "الإعلان — نبذة تحت الاسم (فاضي = نبذة المزود تلقائياً)", value: "", updated_at: "" },
  { key: "hl.ad.desc", group: "إعلان الصفحة الرئيسية", label: "الإعلان — الوصف", value: "تصفحي هذا المزود وتعرفي على خدماته وعروضه للمشتركات.", updated_at: "" },
  { key: "hl.ad.gold", group: "إعلان الصفحة الرئيسية", label: "الإعلان — عبارة العرض", value: "عرض حصري للمشتركات", updated_at: "" },
  { key: "hl.ad.cta", group: "إعلان الصفحة الرئيسية", label: "الإعلان — زر العرض", value: "تصفحي العرض", updated_at: "" },
  { key: "hl.ad.wa.cta", group: "إعلان الصفحة الرئيسية", label: "الإعلان — زر واتساب", value: "تواصلي واتساب", updated_at: "" },
  { key: "hl.ad.wa", group: "إعلان الصفحة الرئيسية", label: "الإعلان — رسالة واتساب", value: "السلام عليكم، جيتك من موقع إزهليها وأبغى أستفسر عن", updated_at: "" },

  // ——— صفحة الفئات والمدن والنتائج ———
  { key: "categories.eyebrow", group: "الفئات والمدن والنتائج", label: "الفئات — السطر الصغير", value: "الفئات", updated_at: "" },
  { key: "categories.title", group: "الفئات والمدن والنتائج", label: "الفئات — العنوان", value: "اختاري الفئة المناسبة لكِ", updated_at: "" },
  { key: "categories.all", group: "الفئات والمدن والنتائج", label: "الفئات — كل الفئات", value: "كل الفئات", updated_at: "" },
  { key: "cities.eyebrow", group: "الفئات والمدن والنتائج", label: "المدن — السطر الصغير", value: "المدن", updated_at: "" },
  { key: "cities.title", group: "الفئات والمدن والنتائج", label: "المدن — العنوان", value: "اختاري مدينتكِ", updated_at: "" },
  { key: "cities.desc", group: "الفئات والمدن والنتائج", label: "المدن — الوصف", value: "اختاري المدينة لعرض مزوّدي الخدمات المتوفرين فيها.", updated_at: "" },
  { key: "cities.empty", group: "الفئات والمدن والنتائج", label: "المدن — لا توجد مدن", value: "لا توجد مدن حاليًا.", updated_at: "" },
  { key: "results.eyebrow", group: "الفئات والمدن والنتائج", label: "النتائج — السطر الصغير", value: "دليل مزوّدي الخدمات", updated_at: "" },
  { key: "results.title", group: "الفئات والمدن والنتائج", label: "النتائج — العنوان", value: "تصفحي مزودي الخدمات", updated_at: "" },
  { key: "results.title.filtered", group: "الفئات والمدن والنتائج", label: "النتائج — عنوان بعد الفلترة", value: "نتائج البحث", updated_at: "" },
  { key: "results.desc", group: "الفئات والمدن والنتائج", label: "النتائج — الوصف", value: "اختاري المدينة والفئة وتطلع لك الخيارات المناسبة.", updated_at: "" },
  { key: "results.reset", group: "الفئات والمدن والنتائج", label: "النتائج — زر إعادة الضبط", value: "إعادة ضبط", updated_at: "" },

  // ——— صندوق البحث والفلاتر ———
  { key: "console.city", group: "البحث والفلاتر", label: "فلتر — المدينة", value: "المدينة", updated_at: "" },
  { key: "console.category", group: "البحث والفلاتر", label: "فلتر — الفئة", value: "الفئة", updated_at: "" },
  { key: "console.category.all", group: "البحث والفلاتر", label: "فلتر — كل الفئات", value: "كل الفئات", updated_at: "" },
  { key: "console.sub", group: "البحث والفلاتر", label: "فلتر — نوع الخدمة", value: "نوع الخدمة", updated_at: "" },
  { key: "console.sub.all", group: "البحث والفلاتر", label: "فلتر — كل الخدمات", value: "كل الخدمات", updated_at: "" },
  { key: "console.cta", group: "البحث والفلاتر", label: "فلتر — زر البحث", value: "ابحثي الآن", updated_at: "" },
  { key: "console.reset", group: "البحث والفلاتر", label: "فلتر — إعادة الضبط", value: "إعادة ضبط", updated_at: "" },
  { key: "filter.price.all", group: "البحث والفلاتر", label: "السعر — كل الأسعار", value: "كل الأسعار", updated_at: "" },
  { key: "filter.price.1", group: "البحث والفلاتر", label: "السعر — الخيار ١", value: "أقل من 5,000 ر.س", updated_at: "" },
  { key: "filter.price.2", group: "البحث والفلاتر", label: "السعر — الخيار ٢", value: "من 5,000 إلى 10,000 ر.س", updated_at: "" },
  { key: "filter.price.3", group: "البحث والفلاتر", label: "السعر — الخيار ٣", value: "من 10,000 إلى 20,000 ر.س", updated_at: "" },
  { key: "filter.price.4", group: "البحث والفلاتر", label: "السعر — الخيار ٤", value: "أكثر من 20,000 ر.س", updated_at: "" },
  { key: "filter.capacity.all", group: "البحث والفلاتر", label: "السعة — كل السعات", value: "كل السعات", updated_at: "" },
  { key: "filter.capacity.1", group: "البحث والفلاتر", label: "السعة — الخيار ١", value: "أقل من 100 ضيف", updated_at: "" },
  { key: "filter.capacity.2", group: "البحث والفلاتر", label: "السعة — الخيار ٢", value: "من 100 إلى 200 ضيف", updated_at: "" },
  { key: "filter.capacity.3", group: "البحث والفلاتر", label: "السعة — الخيار ٣", value: "من 200 إلى 300 ضيف", updated_at: "" },
  { key: "filter.capacity.4", group: "البحث والفلاتر", label: "السعة — الخيار ٤", value: "من 300 إلى 500 ضيف", updated_at: "" },
  { key: "filter.capacity.5", group: "البحث والفلاتر", label: "السعة — الخيار ٥", value: "من 500 إلى 700 ضيف", updated_at: "" },
  { key: "drawer.cta.text", group: "البحث والفلاتر", label: "قائمة البحث — النص", value: "اختاري الفئة ونوع الخدمة والمدينة، وستظهر لكِ الخيارات المناسبة.", updated_at: "" },
  { key: "drawer.cta.btn", group: "البحث والفلاتر", label: "قائمة البحث — الزر", value: "تصفحي الدليل", updated_at: "" },

  // ——— الأسئلة الشائعة ———
  { key: "faq.eyebrow", group: "الأسئلة الشائعة", label: "السطر الصغير", value: "الأسئلة الشائعة", updated_at: "" },
  { key: "faq.title", group: "الأسئلة الشائعة", label: "العنوان", value: "الأسئلة الشائعة", updated_at: "" },
  { key: "faq.desc", group: "الأسئلة الشائعة", label: "الوصف", value: "إجابات واضحة قبل أن تبدئي البحث أو ترسلي طلبكِ.", updated_at: "" },
  { key: "faq.q1", group: "الأسئلة الشائعة", label: "سؤال ١", value: "وش هي أزهليها؟", updated_at: "" },
  { key: "faq.a1", group: "الأسئلة الشائعة", label: "جواب ١", value: "أزهليها مكان واحد يجمع لك كل اللي تحتاجينه لمناسبتك، عشان ما تضيعين بين الخيارات وتتصفحين الخيارات الموجودة في مدينتك.", updated_at: "" },
  { key: "faq.q2", group: "الأسئلة الشائعة", label: "سؤال ٢", value: "أزهليها للأعراس بس؟", updated_at: "" },
  { key: "faq.a2", group: "الأسئلة الشائعة", label: "جواب ٢", value: "لا، تناسب كل المناسبات: أعراس، تخرج، أعياد ميلاد، استقبال مولود وغيرها، حسب الخدمات الموجودة في مدينتك.", updated_at: "" },
  { key: "faq.q3", group: "الأسئلة الشائعة", label: "سؤال ٣", value: "كيف ألقى الخدمة اللي أحتاجها؟", updated_at: "" },
  { key: "faq.a3", group: "الأسئلة الشائعة", label: "جواب ٣", value: "اختاري نوع الخدمة والمدينة، وتطلع لك الخيارات الموجودة عشان تقارنين وتختارين الأنسب لك.", updated_at: "" },
  { key: "faq.q4", group: "الأسئلة الشائعة", label: "سؤال ٤", value: "كيف أطلب عرض من مقدم الخدمة؟", updated_at: "" },
  { key: "faq.a4", group: "الأسئلة الشائعة", label: "جواب ٤", value: "اختاري مزود الخدمة المناسب لك، واضغطي «اطلبي عرضك»، وأرسلي تفاصيل مناسبتك عشان يتواصل معك على واتساب.", updated_at: "" },
  { key: "faq.q5", group: "الأسئلة الشائعة", label: "سؤال ٥", value: "طلب العرض يعني الحجز تأكد؟", updated_at: "" },
  { key: "faq.a5", group: "الأسئلة الشائعة", label: "جواب ٥", value: "لا، طلب العرض ما يعني تأكيد الحجز. تفاصيل طلبك توصل لمقدم الخدمة، وبعدها تتفقين معه مباشرة على السعر والتفاصيل وموعد الحجز.", updated_at: "" },
  { key: "faq.q6", group: "الأسئلة الشائعة", label: "سؤال ٦", value: "أزهليها تضمن جودة الخدمات أو الأسعار؟", updated_at: "" },
  { key: "faq.a6", group: "الأسئلة الشائعة", label: "جواب ٦", value: "أزهليها توفر لك معلومات عن مزودي الخدمة تساعدك تختارين الأنسب. أما السعر النهائي والتوفر وجودة الخدمة، فتتأكدين منها مباشرة مع مقدم الخدمة.", updated_at: "" },
  { key: "faq.q7", group: "الأسئلة الشائعة", label: "سؤال ٧", value: "أزهليها موجودة في كل المدن؟", updated_at: "" },
  { key: "faq.a7", group: "الأسئلة الشائعة", label: "جواب ٧", value: "بدأنا في جدة، وقريب نتوسع لباقي مدن المملكة.", updated_at: "" },
  { key: "faq.q8", group: "الأسئلة الشائعة", label: "سؤال ٨", value: "أقدر أنضم كمقدمة خدمة؟", updated_at: "" },
  { key: "faq.a8", group: "الأسئلة الشائعة", label: "جواب ٨", value: "أكيد، إذا عندك خدمة للمناسبات تقدرين تنضمين لأزهليها وتعرضين خدمتك للعملاء اللي يبحثون عنها.", updated_at: "" },
  { key: "faq.foot", group: "الأسئلة الشائعة", label: "أسفل القسم — النص", value: "لم تجدي إجابتكِ؟", updated_at: "" },
  { key: "faq.foot.cta", group: "الأسئلة الشائعة", label: "أسفل القسم — الزر", value: "تواصلي معنا", updated_at: "" },

  // ——— الفوتر والتواصل ———
  { key: "footer.all", group: "الفوتر والتواصل", label: "الفوتر — رابط الدليل", value: "دليل مقدمات الخدمة", updated_at: "" },
  { key: "footer.join", group: "الفوتر والتواصل", label: "الفوتر — زر الانضمام", value: "انضمّي كمقدمة خدمة", updated_at: "" },
  { key: "contact.wa_number", group: "الفوتر والتواصل", label: "رقم واتساب أزهليها", value: "+966506036094", updated_at: "" },
  { key: "contact.wa_message", group: "الفوتر والتواصل", label: "رسالة واتساب أزهليها الجاهزة", value: "هلا أزهليها، عندي استفسار.", updated_at: "" },

  // ——— صفحة الانضمام ———
  { key: "join.title", group: "صفحة الانضمام", label: "العنوان", value: "انضمّي كمقدمة خدمة", updated_at: "" },
  { key: "join.desc", group: "صفحة الانضمام", label: "الوصف", value: "عبّي البيانات اللي تحت، وبنرسلها مباشرة على واتساب أزهليها ونرجع لك بأسرع وقت.", updated_at: "" },
  { key: "join.f.name", group: "صفحة الانضمام", label: "حقل — اسمك", value: "اسمك", updated_at: "" },
  { key: "join.f.brand", group: "صفحة الانضمام", label: "حقل — اسم الخدمة", value: "اسم الخدمة / المتجر", updated_at: "" },
  { key: "join.f.service", group: "صفحة الانضمام", label: "حقل — نوع الخدمة", value: "نوع الخدمة", updated_at: "" },
  { key: "join.f.city", group: "صفحة الانضمام", label: "حقل — المدينة", value: "المدينة", updated_at: "" },
  { key: "join.f.phone", group: "صفحة الانضمام", label: "حقل — رقم الجوال", value: "رقم الجوال", updated_at: "" },
  { key: "join.f.social", group: "صفحة الانضمام", label: "حقل — الحساب أو الموقع", value: "حساب انستقرام أو الموقع (اختياري)", updated_at: "" },
  { key: "join.f.note", group: "صفحة الانضمام", label: "حقل — نبذة عن الخدمة", value: "وش تقدّمين بالضبط؟ (اختياري)", updated_at: "" },
  { key: "join.submit", group: "صفحة الانضمام", label: "زر الإرسال", value: "إرسال الطلب على واتساب", updated_at: "" },
  { key: "join.hint", group: "صفحة الانضمام", label: "الملاحظة أسفل الزر", value: "بعد الضغط يفتح لك واتساب أزهليها وفيه بياناتك مكتوبة، أرسليها بس.", updated_at: "" },
];

const SITE_TEXT_BASE: SiteTextRow[] = [
  { key: "nav.cta", label: "زر البحث في الهيدر", value: "ابحثي عن مزود خدمة", updated_at: "" },
  ...
  { key: "home.search.placeholder", label: "عبارة البحث السريع", value: "ابحثي عن مزوّد خدمة أو فئة...", updated_at: "" },
  { key: "home.city.label", label: "عبارة اختر مدينتك", value: "اختاري مدينتكِ", updated_at: "" },
  { key: "home.city.all", label: "خيار كل المدن", value: "كل المدن", updated_at: "" },
  { key: "home.city.empty", label: "ما فيه مدن", value: "لا توجد مدن حاليًا.", updated_at: "" },
  { key: "home.categories.title", label: "عنوان التصنيفات", value: "ماذا تحتاجين اليوم؟", updated_at: "" },
  { key: "home.categories.empty", label: "لا توجد تصنيفات", value: "لا توجد فئات حاليًا.", updated_at: "" },
  { key: "home.category.count_suffix", label: "لاحقة عدد مقدمي الخدمة", value: "مزوّد خدمة", updated_at: "" },
  { key: "home.category.coming_soon", label: "قريباً", value: "قريبًا", updated_at: "" },
  { key: "home.category.back", label: "زر الرجوع للتصنيفات", value: "رجوع إلى الفئات", updated_at: "" },
  { key: "home.category.search_placeholder", label: "بحث داخل التصنيف", value: "ابحثي داخل هذه الفئة...", updated_at: "" },
  { key: "home.subs.all", label: "كل التصنيفات الفرعية", value: "الكل", updated_at: "" },
  { key: "home.subs.tertiary_label", label: "عنوان التصنيفات الفرعية", value: "فئات فرعية:", updated_at: "" },
  { key: "home.featured.title", label: "عنوان المميز", value: "خيارات مختارة لكِ", updated_at: "" },
  { key: "home.all_providers.title", label: "عنوان كل المقدمين", value: "كل مزوّدي الخدمات", updated_at: "" },
  { key: "home.category.empty", label: "لا يوجد مقدمين بالتصنيف", value: "لا توجد خيارات في هذه الفئة حاليًا.", updated_at: "" },
  ...
  { key: "home.about.p2", label: "من نحن — الفقرة الثانية", value: "تتصفحين أعمالهم، وتعرفين التفاصيل، وتقارنين الخيارات، وتتواصلين مع مقدم الخدمة مباشرة.", updated_at: "" },
  ...
  { key: "nav.login", label: "زر الدخول (الهيدر)", value: "تسجيل الدخول", updated_at: "" },
  { key: "nav.signup", label: "زر التسجيل (الهيدر)", value: "إنشاء حساب", updated_at: "" },
  ...
  { key: "auth_gate.title", label: "شاشة الأعضاء — العنوان", value: "محتوى للمشتركات", updated_at: "" },
  { key: "auth_gate.description", label: "شاشة الأعضاء — الوصف", value: "للدخول إلى دليل مزوّدي الخدمات، سجّلي الدخول. يحتاج التسجيل كود الشراء الذي وصلكِ بعد طلبكِ من متجر سلة.", updated_at: "" },
  { key: "auth_gate.login", label: "شاشة الأعضاء — زر الدخول", value: "تسجيل الدخول", updated_at: "" },
  { key: "auth_gate.signup", label: "شاشة الأعضاء — زر إنشاء الحساب", value: "إنشاء حساب", updated_at: "" },
  { key: "provider.whatsapp.label", label: "عبارة زر الواتساب", value: "تواصلي عبر واتساب", updated_at: "" },
  { key: "provider.tabs.packages", label: "تبويب — الباقات", value: "الباقات والأسعار", updated_at: "" },
  ...
  { key: "stat.providers", label: "وصف رقم مقدمي الخدمة", value: "مزوّد خدمة", updated_at: "" },
  ...
  { key: "ad.partner", label: "الإعلان — عبارة الشريك", value: "عرض حصري للمشتركات", updated_at: "" },
  { key: "ad.title", label: "الإعلان — العنوان الافتراضي", value: "تحت الضوء هذا الشهر", updated_at: "" },
  { key: "ad.desc", label: "الإعلان — الوصف", value: "اكتشفي هذا المزوّد وتعرّفي على خدماته وعروضه للمشتركات.", updated_at: "" },
  { key: "ad.cta", label: "الإعلان — زر التفاصيل", value: "اكتشفي العرض", updated_at: "" },
  { key: "provider.quote.cta", label: "زر طلب التسعيرة", value: "اطلبي عرضكِ", updated_at: "" },
  { key: "footer.tagline", label: "الفوتر — الوصف", value: "أزهليها تساعدكِ على اكتشاف مزوّدي خدمات المناسبات واختيار ما يناسبكِ بسهولة.", updated_at: "" },
  { key: "footer.explore", label: "الفوتر — عنوان استكشف", value: "تصفحي", updated_at: "" },
  ...
  { key: "footer.motto", label: "الفوتر — العبارة السفلية", value: "اختيارات أوضح، ووقت أقل.", updated_at: "" },
