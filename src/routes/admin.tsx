...
const SITE_TEXT_DEFAULTS: SiteTextRow[] = [
  ...
  { key: "auth_gate.title", label: "شاشة الأعضاء — العنوان", value: "محتوى للأعضاء", updated_at: "" },
  { key: "auth_gate.description", label: "شاشة الأعضاء — الوصف", value: "للدخول إلى دليل مزوّدي الخدمات يلزم تسجيل الدخول. ويحتاج التسجيل كود الشراء الذي وصلكِ بعد طلبكِ من متجر سلة 🤍", updated_at: "" },
