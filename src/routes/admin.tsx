...
const SITE_TEXT_DEFAULTS: SiteTextRow[] = [
  ...
  { key: "home.about.p2", label: "من نحن — الفقرة الثانية", value: "يمكنكِ مشاهدة الأعمال، ومعرفة التفاصيل، ومقارنة الخيارات، والتواصل مباشرةً مع مقدّم الخدمة.", updated_at: "" },
  ...
  { key: "footer.explore", label: "الفوتر — عنوان استكشف", value: "استكشفي", updated_at: "" },
