...
const SITE_TEXT_EXTRA: SiteTextRow[] = [
  ...
  { key: "faq.a1", group: "الأسئلة الشائعة", label: "جواب ١", value: "أزهليها مكان واحد يجمع لك كل اللي تحتاجينه لمناسبتك، عشان ما تضيعين بين الخيارات وتشوفين الخيارات الموجودة في مدينتك.", updated_at: "" },
