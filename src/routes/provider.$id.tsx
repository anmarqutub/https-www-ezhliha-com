...
const css = `
  ...
  .pv-nav { background:#fff; border-bottom:1px solid #d8d4c0; padding:0 24px; height:72px; display:flex; align-items:center; justify-content:space-between; box-shadow:0 2px 12px rgba(100,0,0,0.06); position:sticky; top:0; z-index:50; }
  ...
  .pv-btn-call, .pv-btn-share { background:#f5f2e5; color:#640000; min-height:40px; padding:0 16px; border-radius:6px; text-align:center; text-decoration:none; font-weight:500; display:flex; align-items:center; justify-content:center; gap:8px; border:1px solid #d8d4c0; cursor:pointer; font-family:inherit; font-size:13px; }
...
const css2 = `
  ...
  .pv-icon-btn { width:36px; height:36px; border-radius:8px; border:1px solid #E3DBC9; background:#FFFDF8; color:#640000; cursor:pointer; display:flex; align-items:center; justify-content:center; font-size:16px; }
...
const css3 = `
  ...
  .pv-pkg-arrow { width:36px; height:36px; border-radius:999px; border:1px solid #E3DBC9; background:#FFFDF8; color:#640000; display:inline-flex; align-items:center; justify-content:center; cursor:pointer; transition:background .18s ease, border-color .18s ease; }
  ...
  .pv-srv { display:flex; flex-direction:column; padding:20px; background:#FFFDF8; border:1px solid #E3DBC9; border-radius:12px; text-decoration:none; transition:background .18s ease, box-shadow .18s ease; }
  ...
  .pv-quote-eyebrow { display:block; color:#660000; font-size:12.5px; font-weight:600; margin-bottom:8px; }
