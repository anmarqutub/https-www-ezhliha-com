...
export function HomePage({ view = "home" }: { view?: EzView }) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: txt("faq.a2", "لا، تناسب كل المناسبات: أعراس، تخرج، أعياد ميلاد، استقبال مولود وغيرها، حسب الخدمات الموجودة في مدينتك."),
    },
    {
      q: txt("faq.q3", "كيف ألقى الخدمة اللي أحتاجها؟"),
      a: txt("faq.a3", "اختاري نوع الخدمة والمدينة، وتطلع لك الخيارات الموجودة عشان تقارنين وتختارين الأنسب لك."),
    },
    {
      q: txt("faq.q4", "كيف أطلب عرض من مقدم الخدمة؟"),
      a: txt("faq.a4", "اختاري مقدم الخدمة المناسب لك، واضغطي «اطلبي عرضك»، وأرسلي تفاصيل مناسبتك عشان يتواصل معك على واتساب."),
    },
    {
      q: txt("faq.q5", "طلب العرض يعني الحجز تأكد؟"),
      a: txt("faq.a5", "لا، طلب العرض ما يعني تأكيد الحجز. تفاصيل طلبك توصل لمقدم الخدمة، وبعدها تتفقين معه مباشرة على السعر والتفاصيل وموعد الحجز."),
    },
    {
      q: txt("faq.q6", "أزهليها تضمن جودة الخدمات أو الأسعار؟"),
      a: txt("faq.a6", "أزهليها توفر لك معلومات عن مزودي الخدمة تساعدك تختارين الأنسب. أما السعر النهائي والتوفر وجودة الخدمة، فتتأكدين منها مباشرة مع مقدم الخدمة."),
    },
    {
    ...
    },
    {
      ...
      a: txt("faq.a8", "أكيد، إذا عندك خدمة للمناسبات تقدرين تنضمين لأزهليها وتعرضين خدمتك للعملاء اللي يبحثون عنها."),
    },
  ];
    ...
    <div dir="rtl" className="ez-root">
      ...
      <section className="ez-sec" id="ez-about">
        ...
        <div className="ez-about-page">
          <h3>البداية</h3>
          <p>كل مناسبة فيها لحظة حلوة ننتظرها من وقت طويل.</p>
          <p>
            لحظة نشوف فيها المكان زي ما تخيلناه، ونلبس الإطلالة اللي اخترناها، ونشوف كل تفصيلة تخيلناها صارت قدامنا.
          </p>
          <figure className="ez-about-img">
            <img src={catHalls} alt="قاعة مناسبات مهيأة بإضاءة هادئة" loading="lazy" decoding="async" />
          </figure>

          <h3>المشكلة اللي بغينا نحلها</h3>
          <p>بس الوصول لهذي اللحظة ما يكون سهل دايم. الرحلة تبدأ بسؤال بسيط:</p>
          <ul className="ez-about-q">
            <li>منو يعرف مصورة زينة؟</li>
            <li>وين ألقى القاعة؟</li>
            <li>والضيافة والديكور؟</li>
          </ul>
          <p>
            وبعدها يبدأ البحث بين إنستغرام وواتساب وقروبات العائلة والصديقات. نسأل أكثر من شخص، ونقارن بين خيارات
            كثيرة، ونحاول نلقى الخدمة اللي تناسب ذوقنا وميزانيتنا.
          </p>
          <p>من هنا بدت فكرة أزهليها. قلنا: ليه ما يكون فيه مكان واحد يجمع كل اللي تحتاجينه لمناسبتك؟</p>

          <h3>وش نقدم لك؟</h3>
          <p>عشان كذا بدينا نبني المكان اللي كنا نتمناه من البداية.</p>
          <p>
            أزهليها ما هي بس دليل يعرض أسماء مزودي الخدمات، هي مساحة تساعدك تختارين بثقة ووضوح. تشوفين أعمال
            المزودين، وتعرفين تفاصيل خدماتهم، وتقارنين الخيارات، وتتواصلين مباشرة مع اللي يناسب ذوقك وميزانيتك.
          </p>
          <figure className="ez-about-img">
            <img src={catDecor} alt="تنسيق ورد وديكور لمناسبة" loading="lazy" decoding="async" />
          </figure>
          <p>
            وما نبي نعرض لك نفس الخيارات اللي تلقينها بكل مكان. ندور على مزودين مميزين ما يكون الوصول لهم سهل، لأن
            الخيار الأفضل لك ما هو بالضرورة الأشهر.
          </p>

          <h3>وين وصلنا؟</h3>
          <p>اليوم في أزهليها أكثر من 500 مزود خدمة، ونشتغل على توسيع الدليل لمدن وخدمات أكثر.</p>
          <p>هدفنا بسيط: نخلي البحث عن تفاصيل مناسبتك أسهل وأوضح.</p>
          <p>اختصري وقت البحث وابدئي باختيارك، وخلي البحث علينا.</p>
