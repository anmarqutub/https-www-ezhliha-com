    ...
    <div dir="rtl" className="ez-root">
      ...
      <section className="ez-sec" id="ez-about">
        ...
        <div className="ez-about-page">
          ...
          <p>لكن الطريق لهذي اللحظة غالبًا ما يكون بنفس الجمال.</p>
          <p>يبدأ الموضوع بسؤال بسيط:</p>
          <ul className="ez-about-q">
            <li>مين تعرف مصورة كويسة؟</li>
            <li>طيب والقاعة؟</li>
            <li>والضيافة؟</li>
            <li>والديكور؟</li>
          </ul>
          <p>
            وبعدها تبدأ رحلة البحث بين إنستغرام وواتساب وقروبات العائلة والصديقات، تسألي أكثر من شخص وتضيعين بين
            الخيارات.
          </p>
          <p>وقتها فكرنا: ليش ما يكون فيه مكان واحد يجمع كل اللي تحتاجينه لمناسبتك؟</p>
          <p>ومن هنا بدأت أزهليها.</p>
          ...
          <h3>وين وصلنا؟</h3>
          <p>ومع الوقت، كبرت أزهليها من مجرد فكرة إلى أكثر من 500 مزود خدمة.</p>
          <p>وكل هذا لسبب واحد: نبغى البحث عن مناسبتك يصير أسهل، وأسرع.</p>
          <p>أنتِ عليكِ تختارين وتتحمسين للتفاصيل الحلوة.</p>
          <p>أما دوخة البحث؟ خليها علينا…</p>
          <p className="ez-about-sign">وأزهليها. ❤️</p>
