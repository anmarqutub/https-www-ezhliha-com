...
const codeStyle = { fontFamily: 'Courier, monospace', fontSize: '28px', fontWeight: 'bold' as const, color: '#640000', letterSpacing: '6px', textAlign: 'center' as const, margin: '20px 0', padding: '14px', background: '#fff8f0', borderRadius: '8px' }
